  ...
  return (
    ...
    >
      ...
      <div>
        <div className="flex items-center justify-between gap-2 mb-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded-md bg-slate-800 text-indigo-300 border border-slate-700">
              {word.level}
            </span>
          </div>
        ...
        {/* Example Sentence */}
        <div className="p-2.5 rounded-xl bg-slate-950/70 border border-slate-800/80 mb-3">
      ...
      <div className="mt-2 pt-2 border-t border-slate-800/60 flex flex-col gap-1.5">
        {word.collocations && word.collocations.length > 0 && (
          <div className="flex flex-wrap gap-1 text-[10px]">
            {word.collocations.slice(0, 2).map((col, idx) => (
              <span key={idx} className="px-2 py-0.5 rounded-md bg-slate-800/80 text-slate-300 border border-slate-700/50">
                {col}
              </span>
            ))}
          </div>
        ...
        {word.mnemonic && (
          <div className="flex items-start gap-1.5 text-[11px] text-amber-300/90 bg-amber-500/5 p-2 rounded-lg border border-amber-500/10">
